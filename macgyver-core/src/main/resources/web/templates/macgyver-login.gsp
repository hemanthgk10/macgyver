...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/resources/lte/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="/resources/lte/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
